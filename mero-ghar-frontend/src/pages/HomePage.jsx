...
// //     return <h1 className="text-center mt-10 text-3xl font-bold">Welcome to Mero-Ghar 🏡</h1>;
// // }
...
// export default function HomePage() {
//     // Categories data with random images
//     const categories = [
//         {
//             id: 1,
//             name: 'Beachfront',
...
//     // Listings data with random images
//     const listings = [
//         {
//             id: 1,
...
//                         Welcome to Mero-Ghar <span className="text-airbnb-pink">🏡</span>
//                     </h1>
//                     <p className="text-xl text-gray-600 max-w-3xl mx-auto">
//                         Find your perfect stay in Nepal - from cozy homes to luxury villas
//                     </p>
//                     <Link
//                         to="/listings"
//                         className="mt-8 inline-block bg-airbnb-pink hover:bg-airbnb-pink-dark text-white font-semibold py-3 px-8 rounded-lg transition duration-200"
//                     >
//                         Explore stays
//                     </Link>
//                 </div>
...
//                     <Link
//                         to="/create-listing"
//                         className="inline-block bg-airbnb-pink hover:bg-airbnb-pink-dark text-white font-semibold py-3 px-8 rounded-lg transition duration-200"
//                     >
//                         Become a host
//                     </Link>
//                 </div>
